...
class Content extends amplify_core.Model {
  ...
  const Content._internal({required this.id, contentLabel, contentDescription, createdAt, updatedAt}): _contentLabel = contentLabel, _contentDescription = contentDescription, _createdAt = createdAt, _updatedAt = updatedAt;
  
  factory Content({String? id, String? contentLabel, String? contentDescription}) {
  ...
  bool operator ==(Object other) {
    ...
    return other is Content &&
      id == other.id &&
      _contentLabel == other._contentLabel &&
      _contentDescription == other._contentDescription;
  }
  ...
  String toString() {
    ...
    buffer.write("id=" + "$id" + ", ");
    buffer.write("contentLabel=" + "$_contentLabel" + ", ");
    buffer.write("contentDescription=" + "$_contentDescription" + ", ");
  ...
  Content copyWith({String? contentLabel, String? contentDescription}) {
    return Content._internal(
      id: id,
  ...
  Content copyWithModelFieldValues({
    ModelFieldValue<String?>? contentLabel,
    ModelFieldValue<String?>? contentDescription
  }) {
    return Content._internal(
      id: id,
      contentLabel: contentLabel == null ? this.contentLabel : contentLabel.value,
      contentDescription: contentDescription == null ? this.contentDescription : contentDescription.value
    );
  }
  
  Content.fromJson(Map<String, dynamic> json)  
    : id = json['id'],
      _contentLabel = json['contentLabel'],
      _contentDescription = json['contentDescription'],
      _createdAt = json['createdAt'] != null ? amplify_core.TemporalDateTime.fromString(json['createdAt']) : null,
      _updatedAt = json['updatedAt'] != null ? amplify_core.TemporalDateTime.fromString(json['updatedAt']) : null;
  
  Map<String, dynamic> toJson() => {
    'id': id, 'contentLabel': _contentLabel, 'contentDescription': _contentDescription, 'createdAt': _createdAt?.format(), 'updatedAt': _updatedAt?.format()
  };
  ...
  static final CONTENTLABEL = amplify_core.QueryField(fieldName: "contentLabel");
  static final CONTENTDESCRIPTION = amplify_core.QueryField(fieldName: "contentDescription");
  static var schema = amplify_core.Model.defineSchema(define: (amplify_core.ModelSchemaDefinition modelSchemaDefinition) {
    ...
    modelSchemaDefinition.addField(amplify_core.ModelFieldDefinition.field(
      key: Content.CONTENTLABEL,
      isRequired: false,
      ofType: amplify_core.ModelFieldType(amplify_core.ModelFieldTypeEnum.string)
    ));
    
    modelSchemaDefinition.addField(amplify_core.ModelFieldDefinition.field(
      key: Content.CONTENTDESCRIPTION,
      isRequired: false,
      ofType: amplify_core.ModelFieldType(amplify_core.ModelFieldTypeEnum.string)
    ));
