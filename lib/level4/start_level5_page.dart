...
class StartLevel5Page extends StatefulWidget {
  const StartLevel5Page({ super.key });

  @override
  State<StartLevel5Page> createState() => _StartLevel5PageState();

}
final controller = ScrollController();
class _StartLevel5PageState extends State<StartLevel5Page> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        StartLevel5Widget() : _widgetOptions [_selectedIndex],
...
class StartLevel5Widget extends StatelessWidget {
  const StartLevel5Widget({super.key});
                  ...
                  delegate: SliverChildBuilderDelegate( (BuildContext context, int index) {
                    return Container(
                      ...
                      child: Container(
                        ...
                        child:
                        const Image(
                          image: AssetImage("assets/images/level_05.png"),
                          fit: BoxFit.fill,
                        ),
                      ),
                    );
