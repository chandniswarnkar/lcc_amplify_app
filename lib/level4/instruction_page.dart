...
class _InstructionPageState extends State<InstructionPage> {
  ...
  BottomBarComponent _currentBottomBarComponent = BottomBarComponent.VIEW_OPTION_BUTTON_VIEW;
          ...
          Column(mainAxisAlignment: MainAxisAlignment.center, children: [
            ...
            Visibility(
              ...
              child: Container(
                ...
                child: Column(
                  children: [
                    Text(coinText >= 20? "Description" : questions[_quesIndex],
                      textAlign: TextAlign.center,
                      style: TextStyle(
                        color: Colors.black,
                        fontSize: 24,
                      ...
                      child: Center(
                        ...
                        children: [
                          Text(
                            ...
                            textAlign: TextAlign.center,
                            style: TextStyle(
                              color: textFormFieldValue == ''?Colors.grey : Colors.black,
                              fontSize: 20,
                              fontFamily: 'Inter',
                              fontWeight: FontWeight.w500,
                            ),
                        ...
                        onTap: () {
                          setState(() {
                            if (answers.length > 0) {
                              ...
                              isSelected = true;
                              if (_currentAnsValue == linkBankQuizData[questions[_quesIndex]]) {
                                textFormFieldValue = _currentAnsValue;
                                Timer(Duration(seconds: 1), () {
                                  coinText = coinText + 5;
                                  _currentSliderValue = _currentSliderValue + 15;
                                  if(coinText == 20){
                                    isOptionContainerVisible = false;
                                    isDescriptionContainerVisible = true;
                            ...
                            if (answers1.length > 0) {
                              ...
                              isSelected = true;
                                ...
                                textFormFieldValue = _currentAnsValue;
                                  ...
                                  _currentBottomBarComponent =  BottomBarComponent.EARN_COINS_VIEW;
    ...
    setState(() {
      ...
      if (answers.length > 1) {
        ...
        switch (_currentQuesValue) {
          ...
          case "Transfer Date":
            _currentBottomBarComponent = BottomBarComponent.HINT_PANEL;
            _hintText = 'Date is represented in \nDD/MM/YYYY. You cannot \nmiss it!';
         //   _hintPanelVisible = true;
            break;
          default:
