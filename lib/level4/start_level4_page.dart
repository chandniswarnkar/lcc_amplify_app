...
class StartLevel4Page extends StatefulWidget {
  const StartLevel4Page({ super.key });

  @override
  State<StartLevel4Page> createState() => _StartLevel4PageState();

}
final controller = ScrollController();
class _StartLevel4PageState extends State<StartLevel4Page> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        StartLevel4Widget() : _widgetOptions [_selectedIndex],
...
class StartLevel4Widget extends StatelessWidget {
  const StartLevel4Widget({super.key});
